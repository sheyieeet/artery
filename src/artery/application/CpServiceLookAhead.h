...
#ifndef ARTERY_CPSERVICELOOKAHEAD_H_
#define ARTERY_CPSERVICELOOKAHEAD_H_
...
class CpServiceLookAhead : public ItsG5BaseService
{
public:
    struct VdpSnapshot {
...
#endif /* ARTERY_CPSERVICELOOKAHEAD_H_ */
